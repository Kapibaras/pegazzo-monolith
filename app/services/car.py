...
class CarService:
    ...
    def get_car(self, car_id: str) -> CarDetailResponseSchema:
        ...
        return CarDetailResponseSchema(
            ...
            is_financed_liquidated=car.is_financed_liquidated,
            financing_agency=car.financing_agency,
            financing_purchase_date=car.financing_purchase_date,
            financing_term_months=car.financing_term_months,
            financing_remaining_amount=car.financing_remaining_amount,
    ...
    def create_car(self, data: CarSchema) -> Car:
        ...
        car = Car(
            ...
            is_financed_liquidated=data.is_financed_liquidated,
            financing_agency=data.financing_agency,
            financing_purchase_date=data.financing_purchase_date,
            financing_term_months=data.financing_term_months,
            financing_remaining_amount=data.financing_remaining_amount,
