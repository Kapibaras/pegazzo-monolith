...
class RepositoryFactory:
    ...
    def user_repository(db_session=Depends(get_db)):
        ...
        Args:
            db_session (Session): The database session, injected via FastAPI's Depends.

        Yields:
            UserRepository: An instance of UserRepository initialized with the provided database session.
        """
